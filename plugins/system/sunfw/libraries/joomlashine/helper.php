...
abstract class SunFwHelper
{
	...
	public static function getTemplateVersion ($name)
	{
		...
		$manifest = SunFwHelper::getManifestCache($name);
	...
	public static function getTemplateEdition ($name)
	{
		...
		$manifest = SunFwHelper::getManifest($name);
	...
	public static function getVersionData ()
	{
		if (empty(self::$_versionData))
		{
			...
			{
				throw new Exception('SUN_FW_ERROR_CONTACTING_TO_JOOMLASHINE');
			}
