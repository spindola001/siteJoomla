	...
	public function getAction($return = false)
	{
		...
		$data = array(
			...
			'textMapping' => array(
				...
				'commenting-facebook-num-posts' => JText::_('SUNFW_COMMENTING_FACEBOOK_NUM_POSTS'),
				'commenting-facebook-num-posts-hint' => JText::_('SUNFW_COMMENTING_FACEBOOK_NUM_POSTS_HINT'),
