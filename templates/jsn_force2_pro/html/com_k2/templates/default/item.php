...
<div id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>"> 
		...
		<div class="jsn-article-toolbar">
			...
			<div class="itemToolbar pull-right">
				<ul class="jsn-article-tools">
					...
					<!-- Email Button -->
					<li> <a class="itemEmailLink" rel="nofollow" href="<?php echo $this->item->emailLink; ?>" onclick="window.open(this.href,'emailWindow','width=400,height=350,location=no,menubar=no,resizable=no,scrollbars=no'); return false;"> <i class="fa fa-envelope-o"></i><span><?php echo JText::_('K2_EMAIL'); ?></span> </a> </li>
					<?php endif; ?>
			...
			<div class="jsn-article-info pull-left">
				...
				<!-- Item Author -->
				<span class="author"><i class="fa fa-user-o"></i><span class="catItemAuthor"> <?php echo K2HelperUtilities::writtenBy($this->item->author->profile->gender); ?> <a rel="author" href="<?php echo $this->item->author->link; ?>"><?php echo $this->item->author->name; ?></a> </span></span>
				<?php endif; ?>
				<?php if($this->item->params->get('catItemDateCreated')): ?>
				<!-- Date created -->
				<span class="createdate"><i class="fa fa-calendar"></i><span class="catItemDateCreated" datetime="<?php echo JHtml::_('date', $this->item->created, JText::_(DATE_W3C)); ?>"><?php echo JHTML::_('date', $this->item->created , JText::_('DATE_FORMAT_LC3')); ?> </span></span>
				<?php endif; ?>
				<?php if($this->item->params->get('catItemCategory')): ?>
				<!-- Item category name -->
				<span class="catItemCategory"><i class="fa fa-folder-o"></i><a href="<?php echo $this->item->category->link; ?>"><?php echo $this->item->category->name; ?></a> </span>
				<?php endif; ?>
				...
				<span class="catItemCommentsLink">
					...
					<i class="fa fa-comment-o"></i><a href="<?php echo $this->item->link; ?>#itemCommentsAnchor"> <?php echo $this->item->numOfComments; ?> <?php echo ($this->item->numOfComments>1) ? JText::_('K2_COMMENTS') : JText::_('K2_COMMENT'); ?> </a>
					<?php else: ?>
					<i class="fa fa-comment-o"></i><a href="<?php echo $this->item->link; ?>#itemCommentsAnchor"> <?php echo JText::_('K2_BE_THE_FIRST_TO_COMMENT'); ?> </a>
					<?php endif; ?>
					<?php endif; ?>
				</span>
				<?php endif; ?>
	...
	<div class="itemBody"> 
		...
		<?php if($this->item->params->get('itemTags') || $this->item->params->get('itemAttachments')): ?>
			<div class="itemLinks">
				...
				<!-- Item tags -->
				<div class="itemTagsBlock"><i class="fa fa-tag"></i>
					<ul class="itemTags">
	...
	<div class="itemContentFooter">
		...
		<?php if($this->item->params->get('itemRating')): ?>
			<!-- Item Rating -->
			<div class="itemRatingBlock pull-right"> <span><?php echo JText::_('K2_RATE_THIS_ITEM'); ?></span>
		...
		<ul class="itemCommentsList">
			...
			<li class="<?php echo ($key%2) ? "odd" : "even"; echo (!$this->item->created_by_alias && $comment->userID==$this->item->created_by) ? " authorResponse" : ""; echo($comment->published) ? '':' unpublishedComment'; ?>">
				...
				<div class="itemCommentsWrapper">
					...
					<span class="commentLink" align="right"> <a href="<?php echo $this->item->link; ?>#comment<?php echo $comment->id; ?>" name="comment<?php echo $comment->id; ?>" id="comment<?php echo $comment->id; ?>"> <i class="fa fa-comment"></i> </a> </span>
					</p>
