			...
			<div class="tagItemHeader">
				...
				<div class="jsn-article-toolbar">
						<div class="jsn-article-info">
							...
							<span class="createdate"><i class="fa fa-calendar"></i><span class="tagItemDateCreated"><?php echo JHTML::_('date', $item->created , JText::_('DATE_FORMAT_LC3')); ?></span></span>
							<?php endif; ?>
							<?php if($item->params->get('tagItemCategory')): ?>
							<!-- Item category name -->
							<span class="tagItemLinks">
								<span class="tagItemCategory"><i class="fa fa-folder-o"></i><a href="<?php echo $item->category->link; ?>"><?php echo $item->category->name; ?></a> </span>
							</span>
							<?php endif; ?>
						</div>
				</div>
