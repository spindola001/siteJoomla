		...
		<div class="userItemView<?php if(!$item->published || ($item->publish_up != $this->nullDate && $item->publish_up > $this->now) || ($item->publish_down != $this->nullDate && $item->publish_down < $this->now)) echo ' userItemViewUnpublished'; ?><?php echo ($item->featured) ? ' userItemIsFeatured' : ''; ?>">
			  ...
			  <h3 class="userItemTitle">
				...
				<div class="jsn-article-toolbar">
					...
					<div class="jsn-article-info">
						...
						<!-- Date created -->
						<span class="createdate"><i class="fa fa-calendar"></i><span class="userItemDateCreated"><?php echo JHTML::_('date', $item->created , JText::_('DATE_FORMAT_LC3')); ?></span></span>
						<?php endif; ?>
						<?php if($this->params->get('userItemCategory')): ?>
						<!-- Item category name -->
						<span class="userItemCategory catItemCategory"><i class="fa fa-folder-o"></i>
						...
						<span class="userItemCommentsLink catItemComment">
							<?php if(!empty($item->event->K2CommentsCounter)): ?>
								<!-- K2 Plugins: K2CommentsCounter -->
								<?php echo $item->event->K2CommentsCounter; ?>
							<?php else: ?>
								<?php if($item->numOfComments > 0): ?>
								<i class="fa fa-comment-o"></i><a href="<?php echo $item->link; ?>#itemCommentsAnchor">
		  ...
		  <div class="userItemBody">
			...
			<div class="userItemLinks">
				...
				<!-- Item tags -->
				<div class="userItemTagsBlock"><i class="fa fa-tag"></i>
