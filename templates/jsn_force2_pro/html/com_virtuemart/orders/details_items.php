		...
		<tr valign="top">
			...
			<td align="right"   class="priceCol" >
				...
				if (!empty($item->product_priceWithoutTax) && $item->product_discountedPriceWithoutTax != $item->product_priceWithoutTax) {
					echo '<div class="line-through">'.$this->currency->priceDisplay($item->product_item_price, $this->currency) .'</div>';
					echo '<div >'.$this->currency->priceDisplay($item->product_discountedPriceWithoutTax, $this->currency) .'</div>';
				} else {
					echo '<div >'.$this->currency->priceDisplay($item->product_item_price, $this->currency) .'</div>'; 
				}
				?>
			</td>
			<td align="right" >
