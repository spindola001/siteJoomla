...
<form action="<?php echo JRoute::_('index.php');?>" method="post">
	<div class="search">
		<?php
			...
			if ($button) :
				if ($imagebutton) :
					$button_output = '<input type="image" value="'.$button_text.'" class="button" src="'.$img.'" onclick="this.form.searchword.focus();"/>';
				else :
					$button_output = '<input type="submit" value="'.$button_text.'" class="button" onclick="this.form.searchword.focus();"/>';
				endif;
			endif;

			switch ($button_pos) :
				case 'top' :
					$button_output = '<p align="center">'.$button_output.'</p>';
					$output = $button_output.$output;
					break;

				case 'bottom' :
					$button_output = '<p align="center">'.$button_output.'</p>';
					$output = $output.$button_output;
					break;
