          ...
          <div id="text-content-<?php echo $module->id?>">
            ...
            <div class="image-link-block">
              ...
              if(!empty($images)){
                ...
                foreach ($images as $image) {
                  ?>
                  <span data-image-id="<?php echo $image->id?>" class="image-link" style="display:none;">Image link:<i title="Add link for every whole image or you may add links to every text" class="fa fa-info-circle info_block"></i><input class="image-link-input" type="text" name="image-link[<?php echo $image->id?>]"  size="20" maxlength="300"
                  value="<?php echo $imageLink->{$image->id}   ?>"></span>
                  <?php
                }
              }?>
            </div>
